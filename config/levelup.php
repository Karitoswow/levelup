...
$config['title_items'] = "!A GM Levelup to Item";
$config['body_items'] = "Hi Dear friend, Sent Items were sent to your online server is Decreased";

$config['title_gold'] = "!A GM Levelup to ";
$config['body_gold'] = "Hi Dear friend, Sent Money";
$config['gold_count'] = 5000; // 1000 = 1K   0 = Disable no send gold  soap enbale for  items and money
